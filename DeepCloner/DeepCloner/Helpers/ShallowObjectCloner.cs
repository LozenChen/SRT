...
namespace Force.DeepCloner.Helpers {
    ...
    public abstract class ShallowObjectCloner {
        ...
        private static ShallowObjectCloner GenerateUnsafeCloner() {
            ...
            TypeBuilder builder = mb.DefineType("ShallowSafeObjectClonerImpl", TypeAttributes.Public, typeof(ShallowObjectCloner));
            ConstructorBuilder ctorBuilder = builder.DefineConstructor(MethodAttributes.Public, CallingConventions.HasThis | CallingConventions.HasThis,
                Type.EmptyTypes);
